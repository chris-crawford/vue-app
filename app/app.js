(function (hilary, Vue, KendoDateinputsVueWrapper, KendoButtonsVueWrapper, KendoBarcodesVueWrapper) {
  'use strict'
  ...
  // bootstrap the application
    ...
    (scope, next) => {
      Vue.use(KendoDateinputsVueWrapper.KendoDateinputsInstaller);
      Vue.use(KendoButtonsVueWrapper.ButtonsInstaller)
      Vue.use(KendoBarcodesVueWrapper.BarcodesInstaller);
      next(null, scope);
    },
    (scope, next) => {
...
}(hilary, Vue, KendoDateinputsVueWrapper, KendoButtonsVueWrapper, KendoBarcodesVueWrapper))
